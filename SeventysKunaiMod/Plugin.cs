...

{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        {
            var myLoadedAssetBundle = AssetBundle.LoadFromFile(Path.Combine(Application.streamingAssetsPath, "seventysheirloomwraith"));
            if (myLoadedAssetBundle == null)
            {
                Debug.Log("Failed to load AssetBundle!");
                return;
            }
            var kunai = myLoadedAssetBundle.LoadAsset<GameObject>("kunai");
